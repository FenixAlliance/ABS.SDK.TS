...
export interface paths {
  ...
  "/api/v2/Me/Options/Key/{key}": {
     ...
     */
    get: operations["GetUserOptionByKey"];
  };
  "/api/v2/Me/Options/Upsert/{key}": {
    /**
     * Create or update a user option by key
     * @description Create or update a user option by key
     */
    put: operations["UpsertUserOption"];
  };
  "/api/v2/Me": {
    /**
  ...
  "/api/v2/Me/Enrollments/{enrollmentId}": {
     ...
     */
    get: operations["GetEnrollmentAsync"];
  };
...
export interface components {
  schemas: {
    ...
    ExtendedTenantEnrollmentDtoListEnvelope: {
      ...
      activityId?: string | null;
      result?: components["schemas"]["ExtendedTenantEnrollmentDto"][] | null;
    };
    ExtendedUserDto: {
      id?: string | null;
      /** Format: date-time */
...
export interface operations {
  ...
  PatchCurrentUserAsync: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["PatchOperation"][];
        "application/xml": components["schemas"]["PatchOperation"][];
        "multipart/form-data": components["schemas"]["PatchOperation"][];
      };
    };
    responses: {
      /** @description OK */
  ...
  GetCurrentUserFollowsAsync: {
    ...
    requestBody?: {
      content: {
        ...
        "multipart/form-data": components["schemas"]["FollowRecordDtoCollectionQueryParameters"];
      };
    };
    responses: {
      /** @description OK */
  ...
  GetCurrentUserTenantsAsync: {
    ...
    requestBody?: {
      content: {
        ...
        "multipart/form-data": components["schemas"]["TenantDtoCollectionQueryParameters"];
      };
    };
    responses: {
      /** @description OK */
    ...
    responses: {
      ...
      200: {
        content: {
          ...
          "multipart/form-data": components["schemas"]["TenantEnrollmentDtoListEnvelope"];
        };
      };
      /** @description Unauthorized */
      401: {
  ...
  GetCurrentUserEnrollmentsExtendedAsync: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ExtendedTenantEnrollmentDtoListEnvelope"];
          "application/xml": components["schemas"]["ExtendedTenantEnrollmentDtoListEnvelope"];
          "multipart/form-data": components["schemas"]["ExtendedTenantEnrollmentDtoListEnvelope"];
        };
      };
      /** @description Unauthorized */
      401: {
    ...
    responses: {
      ...
      200: {
        content: {
          ...
          "multipart/form-data": components["schemas"]["TenantEnrollmentDtoEnvelope"];
        };
      };
      /** @description Unauthorized */
      401: {
  ...
  GetCurrentUserNotificationsAsync: {
    ...
    requestBody?: {
      content: {
        ...
        "multipart/form-data": components["schemas"]["NotificationDtoCollectionQueryParameters"];
      };
    };
    responses: {
      /** @description OK */
  ...
  GetCurrentUserAddressesAsync: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["AddressDtoCollectionQueryParameters"];
        "application/xml": components["schemas"]["AddressDtoCollectionQueryParameters"];
        "multipart/form-data": components["schemas"]["AddressDtoCollectionQueryParameters"];
      };
    };
    responses: {
      /** @description OK */
