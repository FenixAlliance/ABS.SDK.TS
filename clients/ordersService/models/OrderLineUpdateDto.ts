...
export type OrderLineUpdateDto = {
    ...
    taxCalculationMethod?: OrderLineUpdateDto.taxCalculationMethod;
    costCalculationMethod?: OrderLineUpdateDto.costCalculationMethod;
...
export namespace OrderLineUpdateDto {
