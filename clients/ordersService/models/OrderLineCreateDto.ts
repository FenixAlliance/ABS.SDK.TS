...
export type OrderLineCreateDto = {
    ...
    taxCalculationMethod?: OrderLineCreateDto.taxCalculationMethod;
    costCalculationMethod?: OrderLineCreateDto.costCalculationMethod;
...
export namespace OrderLineCreateDto {
