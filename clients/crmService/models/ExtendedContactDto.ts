...
export type ExtendedContactDto = {
    id?: string | null;
    timestamp?: string | null;
    readonly qualifiedName?: string | null;
    tenantId?: string | null;
    type?: ExtendedContactDto.type;
    ...
    parentContact?: SimpleContactDto;
    primaryContact?: SimpleContactDto;
};
export namespace ExtendedContactDto {
    export enum type {
        '_0' = 0,
        '_1' = 1,
    }
