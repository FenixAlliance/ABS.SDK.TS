...
export type DealUnitLineCreateDto = {
    ...
    taxCalculationMethod?: DealUnitLineCreateDto.taxCalculationMethod;
    costCalculationMethod?: DealUnitLineCreateDto.costCalculationMethod;
...
export namespace DealUnitLineCreateDto {
