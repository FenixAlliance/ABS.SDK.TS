...
export type DealUnitLineUpdateDto = {
    ...
    taxCalculationMethod?: DealUnitLineUpdateDto.taxCalculationMethod;
    costCalculationMethod?: DealUnitLineUpdateDto.costCalculationMethod;
...
export namespace DealUnitLineUpdateDto {
