...
export type QuoteLineUpdateDto = {
    ...
    taxCalculationMethod?: QuoteLineUpdateDto.taxCalculationMethod;
    costCalculationMethod?: QuoteLineUpdateDto.costCalculationMethod;
...
export namespace QuoteLineUpdateDto {
