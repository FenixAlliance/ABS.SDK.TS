...
export type QuoteLineCreateDto = {
    ...
    taxCalculationMethod?: QuoteLineCreateDto.taxCalculationMethod;
    costCalculationMethod?: QuoteLineCreateDto.costCalculationMethod;
...
export namespace QuoteLineCreateDto {
