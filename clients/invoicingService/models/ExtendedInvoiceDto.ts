...
import type { SimpleTenantEnrolmentDto } from './SimpleTenantEnrolmentDto';
import type { SimpleUserDto } from './SimpleUserDto';
import type { TenantDto } from './TenantDto';
export type ExtendedInvoiceDto = {
    id?: string | null;
    ...
    documentType?: ExtendedInvoiceDto.documentType;
    ...
    enrollment?: SimpleTenantEnrolmentDto;
};
export namespace ExtendedInvoiceDto {
